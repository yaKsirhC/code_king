				...
				<div class="contact-methods grid grid-rows-3 gap-8 md:gap-0 md:grid-rows-none md:grid-cols-3">
					<div class="bg-gray-100">
						...
						<div class="social_media justify-between gap-4 flex ">
							<a tabIndex={1} class="ytb" href="https://www.youtube.com/channel/UC5axhj7vMoAgItncYzR2-pA">
							...
							<a tabIndex={2} class="linkedin" href="https://www.linkedin.com/company/code-king-ofcl">
							...
							<a tabIndex={3} class="facebook" href="https://www.facebook.com/profile.php?id=100094757678196">
							...
							<a tabIndex={4} class="insta" href="https://www.instagram.com/code_king_ck/">
					...
					<div class="bg-ldarkblue text-white md:-my-5 ">
						...
						<a tabIndex={5} href="https://calendly.com/code-king/plan" class="p-2 bg-lred rounded-md text-lg font-semibold">Go to calendly</a>
					</div>
					<div class="email-cont bg-gray-100">
						...
						<a tabIndex={6} class="email" href="mailto:chris-kay@code-king.co">
