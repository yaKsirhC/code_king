				...
				<div class="contact-methods grid grid-rows-3 gap-8 md:gap-0 md:grid-rows-none md:grid-cols-3">
					<div class="bg-gray-100">
						...
						<div class="social_media justify-between gap-4 flex ">
							<a class="ytb" href="https://www.youtube.com/channel/UC5axhj7vMoAgItncYzR2-pA">
							...
							<a class="linkedin" href="https://www.linkedin.com/company/code-king-ofcl">
							...
							<a class="facebook" href="https://www.facebook.com/profile.php?id=100094757678196">
							...
							<a class="insta" href="https://www.instagram.com/code_king_ck/">
					...
					<div class="email-cont bg-gray-100">
						...
						<a class="email" href="mailto:chris-kay@code-king.co">
