export default function Contact() {
  return (
	<div class="gap-16 flex flex-col items-center" >
		<div class="schedule flex gap-4 flex-col items-center">
			<h1 class="title">Schedule Live Meeting</h1>
		...
		<div class="contact-methods p-8 rounded-xl">
			<h1 class="title mb-4">Where You Can Find Us:</h1>
			<div class="social_media justify-evenly flex ">
				<a class="ytb" href="">
